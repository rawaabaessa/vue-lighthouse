  ...
  <div class="bg-gray-50">
    ...
    >
      ...
      <div class="p-5">
        ...
        ><a class="my-3 block" href="https://www.x.com" aria-label="Tutorials"
          >Tutorials <span class="text-teal-600 text-xs p-1"></span></a
        ><a class="my-3 block" href="https://www.x.com" aria-label="Support"
          >Support</a
        >
      </div>
      <div class="p-5">
        <div class="text-sm uppercase text-indigo-600 font-bold">Support</div>
        <a class="my-3 block" href="https://www.x.com" aria-label="Help Center"
        ...
        ><a class="my-3 block" href="https://www.x.com" aria-label="Conditions"
      ...
      <div class="p-5">
        ...
        <a class="my-3 block" href="https://www.x.com" aria-label="address"
          >XXX XXXX, Floor 4 San Francisco, CA
          <span class="text-teal-600 text-xs p-1"></span></a
        ><a class="my-3 block" href="https://www.x.com" aria-label="mail"
